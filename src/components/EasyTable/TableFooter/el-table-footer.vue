<template>
  ...
  >
    ...
    >
      <table-footer ref="fixedLeftFooter" :data="data" fixed="left" />
    </div>
    <div ref="footerWrapper" class="el-table-footer">
      <table-footer ref="footer" :data="data" />
    </div>
    <div
    ...
    >
      <table-footer ref="fixedRightFooter" :data="data" fixed="right" />
    </div>
  </div>
</template>
